...
class SignUpForm(UserCreationForm):
    ...
    phone_number= forms.RegexField(regex='^(?:(?:\+|0{0,2})91(\s*[\-]\s*)?|[0]?)?[6-9]\d{9}$')
    ...
    password1 = forms.CharField(label='Password', widget=forms.PasswordInput,
        help_text=""" Your password cant be too similar to your other personal information. <br/>
    ...
    class Meta:
        ...
        fields = ['first_name','last_name','phone_number','email','gender','date_of_birth', 'password1', 'password2']
